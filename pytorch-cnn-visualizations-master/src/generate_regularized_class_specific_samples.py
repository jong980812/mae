...
class RegularizedClassSpecificImageGeneration():
    ...
    def generate(self, iterations=5000, blur_freq=4, blur_rad=1., wd=0.05, clipping_value=0.1):
        ...
        # os.rename(f'/data/jong980812/project/mae/pytorch-cnn-visualizations-master/generated/class_{self.target_class}',
        #           f'/data/jong980812/project/mae/pytorch-cnn-visualizations-master/generated/class_{self.target_class}_blurfreq_{blur_freq}_blurrad_{blur_rad}_wd{wd}')
